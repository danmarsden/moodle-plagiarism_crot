...
$string['default_threshold']='Defaul Threshold';
$string['global_search_settings']='Global Search settings';
$string['global_search_threshold']='Global Search Threshold';
...
$string['number_of_web_documents']='Number of web documents to be downloaded(1=<)';
$string['clean_tables']='Clean tables (<b>WARNING!</b><br> It removes all Crot data except assignemnts set for check up!<br>Recalculation of fingerprints may cause heavy load on the server)';
